...
var AuthButton = React.createClass({
    render: function() {
        return (
            <div class='container' id="authorize-div">
                <a class="waves-effect waves-light btn-large" id="authorize-button" onclick={this.props.clickEvent}>
                    Sign in to Sheets
                </a>
            </div>
        )
...
//
//         this.setState({client_id: CLIENT_ID, spreadsheet_id: SPREADSHEET_ID, scopes: SCOPES, range: RANGE});
//
//     },
//     auth: function(event) {
...
//        *
//        * @param {Event} evenDt Button click event.
//        */
//         gapi.auth.authorize({
//             client_id: CLIENT_ID,
//             scope: SCOPES,
...
//             gapi.client.sheets.spreadsheets.values.get({spreadsheetId: SPREADSHEET_ID, range: RANGE}).then(function(response) {
...
//         var component;
//         if(this.state.data){
//           component = <StatSearch data={this.state.data} />;
//         }
//         else{
//           component = <AuthButton clickEvent={this.auth} />;
//         }
//         return (
//
//         )
...
//       return(
//         {this.state.data && StatSearch data={this.state.data} / >
// })
// }});
